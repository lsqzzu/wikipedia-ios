...
- (BOOL)fetchedResultsAreCloseToLocation:(CLLocation *)location {
    if ([self.searchResults.location distanceFromLocation:location]<500 && [self.searchResults.searchSite isEqualToSite:self.searchSite] && [self.searchResults.results count]> 0) {
        return YES;
    }
