...
@interface WMFMostReadTitlesResponseItemArticle : MTLModel <MTLJSONSerializing>
...
@interface WMFMostReadTitlesResponseItem : MTLModel <MTLJSONSerializing>
...
@interface WMFMostReadTitlesResponse : MTLModel <MTLJSONSerializing>
