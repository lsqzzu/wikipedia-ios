...
- (void)testExpectedSummaryForObamaArticle {
    ...
    MWKTitle *dummyTitle =
        [MWKTitle titleWithString:@"foo"
                             site:[MWKSite siteWithDomain:@"wikipedia.org" language:@"en"]];
    self.article = [[MWKArticle alloc] initWithTitle:dummyTitle dataStore:nil dict:obamaMobileViewJSON[@"mobileview"]];
    assertThat(self.article.summary, is(@"Barack Hussein Obama II is the 44th and current President of the United States, and the first African American to hold the office. Born in Honolulu, Hawaii, Obama is a graduate of Columbia University and Harvard Law School, where he served as president of the Harvard Law Review. He was a community organizer in Chicago before earning his law degree. He worked as a civil rights attorney and taught constitutional law at the University of Chicago Law School from 1992 to 2004. He served three ter"));
}
...
- (void)testExpectedSummaryForHawaiiArticle {
    ...
    MWKTitle *dummyTitle =
        [MWKTitle titleWithString:@"foo"
                             site:[MWKSite siteWithDomain:@"wikipedia.org" language:@"en"]];
    self.article = [[MWKArticle alloc] initWithTitle:dummyTitle dataStore:nil dict:obamaMobileViewJSON[@"mobileview"]];
    assertThat(self.article.summary, is(@"Hawaii is the 50th and most recent U.S. state to join the United States, having joined on August 21, 1959. Hawaii is the only U.S. state located in Oceania and the only one composed entirely of islands. It is the northernmost island group in Polynesia, occupying most of an archipelago in the central Pacific Ocean. Hawaii is the only U.S. state not located in the Americas. The state does not observe daylight saving time. The state encompasses nearly the entire volcanic Hawaiian archipelago, which"));
}
...
- (void)testExpectedSummaryForMiniArticle {
    ...
    MWKTitle *dummyTitle =
        [MWKTitle titleWithString:@"foo"
                             site:[MWKSite siteWithDomain:@"wikipedia.org" language:@"en"]];
    self.article = [[MWKArticle alloc] initWithTitle:dummyTitle dataStore:nil dict:obamaMobileViewJSON[@"mobileview"]];
    assertThat(self.article.summary, is(@"The Mini is a small economy car made by the British Motor Corporation and its successors from 1959 until 2000. The original is considered a British icon of the 1960s. The Mini was the star car of the main character of animated TV series Mr. Bean. Its space-saving transverse engine front-wheel drive layout – allowing 80 percent of the area of the car's floorpan to be used for passengers and luggage – influenced a generation of car makers. In 1999 the Mini was voted the second most influential car of the"));
}
