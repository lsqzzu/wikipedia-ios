...
- (void)testTwoArticlesWithSameTitlesAreEqual {
    ...
    MWKArticle *foo =
        [[MWKArticle alloc] initWithTitle:title
                                dataStore:nil];
    MWKArticle *foo2 =
        [[MWKArticle alloc] initWithTitle:title
                                dataStore:nil];
...
- (void)testTwoArticlesWithSameTitleButDifferentFragmentAreEqual {
    MWKArticle *foo =
        [[MWKArticle alloc] initWithTitle:
                                [[MWKTitle alloc] initWithURL:[NSURL URLWithString:@"//en.wikipedia.org/wiki/Foo"]]
                                dataStore:nil];
    MWKArticle *fooWithBarFragment =
        [[MWKArticle alloc] initWithTitle:
                                [[MWKTitle alloc] initWithURL:[NSURL URLWithString:@"//en.wikipedia.org/wiki/Foo#bar"]]
                                dataStore:nil];
...
- (void)testTwoArticlesWithDifferentTitlesAreNotEqual {
    ...
    MWKArticle *bar =
        [[MWKArticle alloc] initWithTitle:
                                [[MWKTitle alloc] initWithURL:[NSURL URLWithString:@"//en.wikipedia.org/wiki/Bar"]]
                                dataStore:nil];
