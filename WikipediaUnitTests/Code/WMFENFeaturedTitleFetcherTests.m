...
- (void)testExample {
    ...
    NSRegularExpression *tfaTitleRequest =
        [NSRegularExpression regularExpressionWithPattern:testDatePattern
                                                  options:0
                                                    error:nil];

    // expected title matches the one in the JSON fixture
    NSRegularExpression *previewRequest =
        [NSRegularExpression regularExpressionWithPattern:@"https://en\\.wikipedia\\.org.*titles=Mackensen-class%20battlecruiser.*"
                                                  options:0
                                                    error:nil];
