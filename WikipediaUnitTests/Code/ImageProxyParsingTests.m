...
- (void)testAttributesOtherThanSrcAndSrcsetAreUnchanged {
    ...
    NSString *expected = [NSString stringWithFormat:@""
                                                     "<img alt=\"\" src=\"%@/imageProxy?originalSrc=//upload.wikimedia.org/wikipedia/commons/thumb/1/11/Barack_Obama_signature.svg/128px-Barack_Obama_signature.svg.png\" srcset=\"%@/imageProxy?originalSrc=//test2x.png 2x\" width=\"128\" height=\"31\"/>",
                                                    self.baseURLString, self.baseURLString];
...
- (void)testMultipleImageTagsAreChangedButNonImageTagsAreUnchanged {
    ...
    NSString *expected = [NSString stringWithFormat:@""
                                                     ...
                                                     "<img src=\"%@/imageProxy?originalSrc=//test.png\" srcset=\"%@/imageProxy?originalSrc=//test2x.png 2x\">"
                                                     "<someothertag src=\"//test.png\" srcset=\"//test2x.png 2x\">"
                                                     "<img src=\"%@/imageProxy?originalSrc=//testThis.png\" srcset=\"%@/imageProxy?originalSrc=//testThis2x.png 2x\">",
                                                    self.baseURLString, self.baseURLString, self.baseURLString, self.baseURLString];
    ;
